...
class SmsMessagesListRequest(BaseModel):
    ...
    query_params: SmsMessagesListQueryParams = Field(default_factory=SmsMessagesListQueryParams)
...
class SmsMessage(BaseMailerSendModel):
    ...
    sms_activity: Optional[List[SmsActivity]] = Field(None, description="SMS activity objects")
