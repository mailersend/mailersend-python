...
class AnalyticsBuilder:
    ...
    def date_range_days(self, days: int, end_date: Optional[datetime] = None) -> 'AnalyticsBuilder':
        """
    ...
    def date_range_weeks(self, weeks: int, end_date: Optional[datetime] = None) -> 'AnalyticsBuilder':
        """
    ...
    def date_range_months(self, months: int, end_date: Optional[datetime] = None) -> 'AnalyticsBuilder':
        """
    ...
    def group_by(self, group_by: Literal["days", "weeks", "months", "years"]) -> 'AnalyticsBuilder':
        """
    ...
    def event(self, *events: str) -> 'AnalyticsBuilder':
        ...
        for event in events:
            if event not in valid_events:
                raise ValidationError(f"Invalid event: {event}. Valid events: {', '.join(valid_events)}")
    ...
    def delivery_events(self) -> 'AnalyticsBuilder':
        ...
        Returns:
            AnalyticsBuilder instance for chaining
        """
        return self.events("queued", "sent", "delivered", "soft_bounced", "hard_bounced")
