...
class AsyncSmsWebhooks(AsyncBaseResource):
    """Async SMS Webhooks resource."""

    async def list_sms_webhooks(self, request: SmsWebhooksListRequest) -> APIResponse:
        """List SMS webhooks.
    ...
    async def get_sms_webhook(self, request: SmsWebhookGetRequest) -> APIResponse:
        """Get a single SMS webhook.
    ...
    async def create_sms_webhook(self, request: SmsWebhookCreateRequest) -> APIResponse:
        """
        Create an SMS webhook.
    ...
    async def update_sms_webhook(self, request: SmsWebhookUpdateRequest) -> APIResponse:
        """
        Update an SMS webhook.
    ...
    async def delete_sms_webhook(self, request: SmsWebhookDeleteRequest) -> APIResponse:
        """
        Delete an SMS webhook.
