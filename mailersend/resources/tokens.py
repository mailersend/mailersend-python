...
class AsyncTokens(AsyncBaseResource):
    """Async Tokens API resource."""

    async def list_tokens(self, request: TokensListRequest) -> APIResponse:
        """List API tokens.
        ...
        """
        params = request.to_query_params()
        response = await self.client.request(method="GET", path="token", params=params)
        return self._create_response(response)

    async def get_token(self, request: TokenGetRequest) -> APIResponse:
        """Get a single API token.
    ...
    async def create_token(self, request: TokenCreateRequest) -> APIResponse:
        """Create an API token.
    ...
    async def update_token(self, request: TokenUpdateRequest) -> APIResponse:
        """Update an API token status.
    ...
    async def update_token_name(self, request: TokenUpdateNameRequest) -> APIResponse:
        """Update an API token name.
    ...
    async def delete_token(self, request: TokenDeleteRequest) -> APIResponse:
        """Delete an API token.
