...
class SmtpUsers(BaseResource):
    ...
    def list_smtp_users(self, request: SmtpUsersListRequest) -> APIResponse:
        ...
        """
        logger.info(f"Listing SMTP users for domain: {request.domain_id} with limit: {request.query_params.limit}")
    ...
    def get_smtp_user(self, request: SmtpUserGetRequest) -> APIResponse:
        ...
        """
        logger.info(f"Getting SMTP user: {request.smtp_user_id} from domain: {request.domain_id}")
    ...
    def create_smtp_user(self, request: SmtpUserCreateRequest) -> APIResponse:
        ...
        """
        logger.info(f"Creating SMTP user: {request.name} for domain: {request.domain_id}")
    ...
    def update_smtp_user(self, request: SmtpUserUpdateRequest) -> APIResponse:
        ...
        """
        logger.info(f"Updating SMTP user: {request.smtp_user_id} in domain: {request.domain_id}")
    ...
    def delete_smtp_user(self, request: SmtpUserDeleteRequest) -> APIResponse:
        ...
        """
        logger.info(f"Deleting SMTP user: {request.smtp_user_id} from domain: {request.domain_id}")
