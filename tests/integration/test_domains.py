...
def base_domains_query_params():
    ...
    return DomainListQueryParams(page=1, limit=25, verified=None)
...
def domains_request_factory(
    base_query_params: DomainListQueryParams, **overrides
) -> DomainListRequest:
...
def inject_common_objects(
    request,
    email_client,
    base_domains_request,
    base_domains_query_params,
    test_domain_id,
    create_domain_name,
    test_domain_name,
):
...
class TestDomainsIntegrationListDomains:
    ...
    def test_list_domains_basic(self):
        ...
        request = self.domains_request_factory(
            self.base_domains_query_params, page=1, limit=10
        )
    ...
    def test_list_domains_with_pagination(self):
        ...
        request = self.domains_request_factory(
            self.base_domains_query_params, page=2, limit=10
        )
    ...
    def test_list_domains_verified_only(self):
        ...
        request = self.domains_request_factory(self.base_domains_query_params, limit=10)
    ...
    def test_list_domains_builder(self):
        ...
        request = (
            builder.page(1).limit(15).build_list_request()
        )  # Remove verified_only() to avoid API issues
...
class TestDomainsIntegrationCreateDomain:
    ...
    def test_create_domain_minimal(self):
        ...
        request = DomainCreateRequest(name=self.create_domain_name)
...
class TestDomainsIntegrationUpdateSettings:
    ...
    def test_update_domain_settings_pause_sending(self):
        ...
        request = DomainUpdateSettingsRequest(
            domain_id=self.test_domain_id, send_paused=True
        )
    ...
    def test_update_domain_settings_builder(self):
        ...
        builder = DomainsBuilder()
        request = (
            builder.domain_id(self.test_domain_id)
            .enable_all_tracking()
            .resume_sending()
...
class TestDomainsIntegrationRecipients:
    ...
    def test_get_domain_recipients_basic(self):
        ...
        request = DomainRecipientsRequest(
            domain_id=self.test_domain_id, query_params=query_params
        )
...
class TestDomainsIntegrationDeleteDomain:
    ...
    def test_delete_domain_success(self):
        ...
        create_request = DomainCreateRequest(name="somerandomdomain.com")
        create_response = self.email_client.domains.create_domain(create_request)

        # Delete the domain using request model
        delete_request = DomainDeleteRequest(domain_id=create_response["data"]["id"])
    ...
    def test_delete_domain_not_found(self):
        ...
        delete_request = DomainDeleteRequest(domain_id="non-existent-domain-id")
    ...
    def test_domain_settings_workflow(self):
        ...
        enable_response = self.email_client.domains.update_domain_settings(
            enable_request
        )
        ...
        disable_response = self.email_client.domains.update_domain_settings(
            disable_request
        )
