...
def basic_messages_list_request():
    ...
    return MessagesListRequest(query_params=MessagesListQueryParams(page=1, limit=10))
...
class TestMessagesIntegration:
    ...
    def test_list_messages_empty_result(
        self, email_client, basic_messages_list_request
    ):
...
class TestMessagesBuilderIntegration:
    ...
    def test_comprehensive_messages_workflow(self, email_client):
        ...
        builder_get_request = builder.message_id(
