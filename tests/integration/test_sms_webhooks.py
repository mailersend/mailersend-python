...
def sms_webhook_update_request():
    ...
    return SmsWebhookUpdateRequest(
        sms_webhook_id="test-sms-webhook-id", name="Updated SMS Webhook", enabled=False
    )
...
class TestSmsWebhooksIntegration:
    ...
    def test_list_sms_webhooks_basic(
        self, email_client, basic_sms_webhooks_list_request
    ):
    ...
    def test_list_sms_webhooks_with_invalid_sms_number(self, email_client):
        ...
        request = SmsWebhooksListRequest(
            query_params=SmsWebhooksListQueryParams(
                sms_number_id="invalid-sms-number-id"
            )
        )
    ...
    def test_get_sms_webhook_not_found_with_test_id(
        self, email_client, sms_webhook_get_request
    ):
    ...
    def test_create_sms_webhook_invalid_sms_number(
        self, email_client, sample_sms_webhook_create_request
    ):
        ...
        with pytest.raises((BadRequestError, ResourceNotFoundError)) as exc_info:
            email_client.sms_webhooks.create_sms_webhook(
                sample_sms_webhook_create_request
            )
    ...
    def test_create_sms_webhook_with_all_events(
    ...
    def test_update_sms_webhook_not_found_with_test_id(
        self, email_client, sms_webhook_update_request
    ):
    ...
    def test_update_sms_webhook_disable(self, email_client):
        ...
        request = SmsWebhookUpdateRequest(
            sms_webhook_id="test-sms-webhook-id", enabled=False
        )
    ...
    def test_delete_sms_webhook_not_found_with_test_id(
        self, email_client, sms_webhook_delete_request
    ):
