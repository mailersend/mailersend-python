...
def basic_schedules_list_request():
    ...
    return SchedulesListRequest(query_params=SchedulesListQueryParams(page=1, limit=10))
...
class TestSchedulesIntegration:
    ...
    def test_list_schedules_basic(self, email_client, basic_schedules_list_request):
        ...
        if "data" in response.data:
            ...
            if schedules:
                ...
                assert (
                    "subject" in first_schedule or "send_at" in first_schedule
                )  # API may not always include subject
    ...
    def test_list_schedules_with_status_filter(self, email_client):
        ...
        request = SchedulesListRequest(
            query_params=SchedulesListQueryParams(page=1, limit=10, status="scheduled")
        )
    ...
    def test_get_schedule_not_found_with_test_id(
        self, email_client, schedule_get_request
    ):
    ...
    def test_delete_schedule_not_found_with_test_id(
        self, email_client, schedule_get_request
    ):
        ...
        assert (
            ...
            or "404" in error_str
            or "could not be found" in error_str
            or "not possible to delete" in error_str
            or "already been sent" in error_str
        )
    ...
    def test_list_schedules_empty_result(
        self, email_client, basic_schedules_list_request
    ):
    ...
    def test_schedules_list_query_params_validation(self):
        ...
        params = SchedulesListQueryParams(
            page=1, limit=25, domain_id="test-domain", status="scheduled"
        )
    ...
    def test_schedules_list_query_params_to_dict(self):
        ...
        params = SchedulesListQueryParams(
            page=2, limit=50, domain_id="test-domain", status="sent"
        )
