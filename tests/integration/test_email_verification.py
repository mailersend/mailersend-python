...
class TestEmailVerificationIntegration:
    ...
    def test_list_email_verification_lists_basic(self, email_client, basic_list_request):
    ...
    def test_get_email_verification_list_success(self, email_client, verification_get_request):
        ...
        if 'data' in response.data:
            ...
            assert verification_list['id'] == verification_get_request.email_verification_id
    ...
    def test_verify_email_verification_list(self, email_client, verification_get_request):
        ...
        if 'data' in response.data:
            ...
            if 'status' in verification_data:
                assert verification_data['status'] in ['processing', 'verified', 'pending']

    @vcr.use_cassette("email_verification_get_results.yaml")
    def test_get_email_verification_results(self, email_client, verification_get_request):
    ...
    def test_comprehensive_email_verification_workflow(self, email_client, sample_email_list):
        ...
        get_request = EmailVerificationGetRequest(
        ...
        results_response = email_client.email_verification.get_list_results(results_request)
    ...
    def test_list_email_verification_empty_result(self, email_client, basic_list_request):
