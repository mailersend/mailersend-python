...
from mailersend.models.recipients import (
    RecipientsListRequest, RecipientGetRequest, RecipientDeleteRequest,
    SuppressionListRequest, SuppressionAddRequest, SuppressionDeleteRequest,
    RecipientsListQueryParams, SuppressionQueryParams
)
...
def suppression_list_request():
    ...
    return SuppressionListRequest(
        ...
        query_params=SuppressionQueryParams(
            page=1,
            limit=10
        )
    )
...
class TestRecipientsIntegration:
    ...
    def test_list_recipients_basic(self, email_client, basic_recipients_list_request):
        ...
        response = email_client.recipients.list_recipients(basic_recipients_list_request)
    ...
    def test_get_recipient_not_found(self, email_client):
        ...
        request = RecipientGetRequest(
            recipient_id="non-existent-recipient-id"
        )
    ...
    def test_add_to_blocklist_success(self, email_client, sample_recipients_list):
        ...
        request = SuppressionAddRequest(
            domain_id="test-domain-id",
            recipients=sample_recipients_list
        )
    ...
    def test_list_recipients_empty_result(self, email_client, basic_recipients_list_request):
