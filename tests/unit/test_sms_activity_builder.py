...
class TestSmsActivityBuilder:
    ...
    def test_reset_method(self, builder):
        ...
        # Set some state
        builder.sms_number_id("7z3m5jgrogdpyo6n").date_from(1443651141).status(["delivered"]).page(2).limit(50).sms_message_id("62134a2d7de3253bf10d6642")
    ...
    def test_multiple_requests_from_same_builder(self, builder):
        ...
        builder.sms_number_id("7z3m5jgrogdpyo6n").date_from(1443651141).sms_message_id("62134a2d7de3253bf10d6642")
