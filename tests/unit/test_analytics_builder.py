...
class TestAnalyticsBuilder:
    ...
    def test_timestamp_validation(self):
        ...
        with pytest.raises(ValidationError, match="Timestamp must be a positive integer"):
    ...
    def test_delivery_events_helper(self):
        ...
        expected_events = ["queued", "sent", "delivered", "soft_bounced", "hard_bounced"]
        assert request.event == expected_events
