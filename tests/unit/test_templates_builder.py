...
class TestTemplatesBuilder:
    ...
    def test_method_chaining(self):
        ...
        result = self.builder.domain_id("domain-123").page(2).limit(50)
    ...
    def test_build_templates_list_request_partial(self):
        ...
        request = self.builder.domain_id("domain-123").build_templates_list_request()
    ...
    def test_build_templates_list_request_only_set_explicit_values(self):
        ...
        request = self.builder.page(3).build_templates_list_request()
    ...
    def test_build_template_get_request(self):
        ...
        request = self.builder.template_id("template-123").build_template_get_request()
    ...
    def test_build_template_delete_request(self):
        ...
        request = self.builder.template_id(
            "template-123"
