...
class TestActivityBuilder:
    ...
    def test_page_setting(self):
        ...
        request = (
            builder.domain_id("test").date_from(1672574400).date_to(1672660800).build()
        )
    ...
    def test_copy_builder(self):
        ...
        original.domain_id("test-domain").page(2).event("sent").date_from(
            1672574400
        ).date_to(1672660800)
    ...
    def test_reset_builder(self):
        ...
        builder = ActivityBuilder()
        builder.domain_id("test-domain").page(2).event("sent").date_from(
            1672574400
        ).date_to(1672660800)
