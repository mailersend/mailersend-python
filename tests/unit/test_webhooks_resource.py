...
class TestWebhooks:
    ...
    def test_integration_workflow(self):
        ...
        assert isinstance(self.resource.list_webhooks(request_list), type(self.mock_api_response))
        assert isinstance(self.resource.get_webhook(request_get), type(self.mock_api_response))
        assert isinstance(self.resource.create_webhook(request_create), type(self.mock_api_response))
        assert isinstance(self.resource.update_webhook(request_update), type(self.mock_api_response))
        assert isinstance(self.resource.delete_webhook(request_delete), type(self.mock_api_response)) 