...
class TestAnalyticsRequest:
    ...
    def test_valid_analytics_request(self):
        ...
        assert request.recipient_id == ["recipient1@example.com", "recipient2@example.com"]
