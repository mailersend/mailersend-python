...
class TestEmailVerificationBuilder:
    ...
    def test_build_verify_email_missing_email(self):
        ...
        with pytest.raises(
            ValueError, match="email is required for email verification request"
        ):
    ...
    def test_build_verify_email_async_missing_email(self):
        ...
        with pytest.raises(
            ValueError, match="email is required for async email verification request"
        ):
    ...
    def test_build_async_status_missing_id(self):
        ...
        with pytest.raises(
            ValueError,
            match="email_verification_id is required for async status request",
        ):
    ...
    def test_build_get_missing_id(self):
        ...
        with pytest.raises(
            ValueError,
            match="email_verification_id is required for get verification request",
        ):
    ...
    def test_build_create_missing_name(self):
        ...
        with pytest.raises(
            ValueError, match="name is required for create verification request"
        ):
    ...
    def test_build_create_missing_emails(self):
        ...
        with pytest.raises(
            ValueError, match="emails are required for create verification request"
        ):
    ...
    def test_build_verify_list_missing_id(self):
        ...
        with pytest.raises(
            ValueError,
            match="email_verification_id is required for verify list request",
        ):
    ...
    def test_build_results_with_custom_params(self):
        ...
        results = ["valid", "catch_all"]
        request = (
            self.builder.email_verification_id("abc123")
            .page(2)
            .limit(50)
            .results(results)
            .build_results()
    ...
    def test_build_results_missing_id(self):
        ...
        with pytest.raises(
            ValueError, match="email_verification_id is required for results request"
        ):
