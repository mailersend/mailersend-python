...
class TestDomainsBuilderBasicOperations:
    ...
    def test_reset_method(self):
        ...
        # Set various fields
        builder.page(2).limit(50).verified(True).domain_name("test.com").track_opens(
            True
        )
    ...
    def test_copy_method(self):
        ...
        original.page(1).limit(25).verified(True).domain_name("test.com").domain_id(
            "domain-123"
        )
...
class TestDomainsBuilderPagination:
    ...
    def test_page_method(self):
        ...
        with pytest.raises(
            MailerSendValidationError, match="Page must be greater than 0"
        ):
            builder.page(0)
    ...
    def test_limit_method(self):
        ...
        with pytest.raises(
            MailerSendValidationError, match="Limit must be between 10 and 100"
        ):
            builder.limit(5)
...
class TestDomainsBuilderBuildMethods:
    ...
    def test_build_create_request_complete(self):
        ...
        builder = DomainsBuilder()
        builder.domain_name("mydomain.com").return_path_subdomain(
            "mail"
        ).custom_tracking_subdomain("track").inbound_routing_subdomain("inbox")
    ...
    def test_build_update_settings_request_complete(self):
        ...
        builder = DomainsBuilder()
        builder.domain_id("test-domain-id").track_opens(True).track_clicks(
            False
    ...
    def test_build_recipients_request_basic(self):
        ...
        )  # Default from DomainRecipientsQueryParams
        assert (
    ...
    def test_build_get_request_missing_domain_id(self):
        ...
        with pytest.raises(
            MailerSendValidationError, match="Domain ID is required for getting domain"
        ):
    ...
    def test_build_dns_records_request_missing_domain_id(self):
        ...
        with pytest.raises(
            ...
            match="Domain ID is required for getting DNS records",
        ):
    ...
    def test_build_verification_request_missing_domain_id(self):
        ...
        with pytest.raises(
            MailerSendValidationError,
            match="Domain ID is required for getting verification status",
        ):
    ...
    def test_build_update_settings_request_missing_domain_id(self):
        ...
        with pytest.raises(
            MailerSendValidationError,
            match="Domain ID is required for updating settings",
        ):
    ...
    def test_build_recipients_request_missing_domain_id(self):
        ...
        with pytest.raises(
            MailerSendValidationError,
            match="Domain ID is required for getting recipients",
        ):
...
class TestDomainsBuilderComplexScenarios:
    ...
    def test_chained_method_calls(self):
        ...
        request = builder.page(3).limit(50).verified_only().build_list_request()
        ...
        builder.reset()
        create_request = (
            builder.domain_name("newdomain.com")
