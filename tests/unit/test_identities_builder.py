...
class TestIdentityBuilder:
    ...
    def test_build_list_request_query_params_delegation(self):
        ...
        expected = {"page": 4, "limit": 75, "domain_id": "domain789"}
    ...
    def test_build_update_request(self):
        ...
        builder.reply_to_name("Updated Reply").add_note(False).personal_note(
            "Updated note"
        )
        request = builder.build_update_request()
        assert isinstance(request, IdentityUpdateRequest)
    ...
    def test_builder_state_independence(self):
        ...
        builder.domain_id("domain123").identity_id("identity123").email(
            "john@example.com"
        )
    ...
    def test_builder_reuse(self):
        ...
        request2 = (
            builder.name("Jane Doe").email("jane@example.com").build_create_request()
        )
